...
whitelisted_from_arsenal = [
	...
	"Binocular", "Rangefinder", "ItemCompass", "ItemGPS",
	"ItemMap", "ItemRadio", "ItemWatch", "Bandage",
	"HandGrenade", "MiniGrenade","O_IR_Grenade","Laserbatteries",
	"APERSMine_Range_Mag", "APERSTripMine_Wire_Mag", "APERSBoundingMine_Range_Mag",
	"ATMine_Range_Mag", "SatchelCharge_Remote_Mag", "DemoCharge_Remote_Mag",
	"SLAMDirectionalMine_Wire_Mag",	"ClaymoreDirectionalMine_Remote_Mag",
	"rhs_weap_pm63", "rhs_acc_dtkakm", "rhs_acc_2dpZenit", "rhs_30Rnd_762x39mm",
	"rhs_weap_rpg7", "rhs_rpg7_PG7VL_mag", "LOP_U_IRA_Fatigue_HTR_BLK",
	"LOP_V_CarrierLite_TAN", "rhs_mag_rgd5", "rhs_30Rnd_762x39mm_tracer",
	"rhssaf_mag_brd_m83_white", "rhssaf_mag_brz_m88", "rhs_30Rnd_762x39mm",
	"rhs_mag_rdg2_white", "rhs_30Rnd_762x39mm_tracer", "LOP_H_Turban_mask",
	"rhs_radio_R187P1"
